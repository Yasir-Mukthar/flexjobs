...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14 ">
      ...
      Innovate Your Career – Browse Thousands of Jobs in Engineering & Technology!      </p>
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          ...
          <button
            type="submit"
            className="bg-blue text-white md:rounded-s-none rounded py-2 px-8 md:w-1/6 w-full"
          >
            Search
          </button>
        </div>
